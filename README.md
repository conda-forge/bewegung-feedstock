...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bewegung-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11371&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bewegung-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bewegung` can be installed with:

```
conda install bewegung
```

It is possible to list all of the versions of `bewegung` available on your platform with:
